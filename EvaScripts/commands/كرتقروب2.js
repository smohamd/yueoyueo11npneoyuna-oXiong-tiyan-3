...
/*---------------------------------------------*/
  ...
  ctx.drawImage(baseAva, 910, 465, 229, 229);
  ctx.drawImage(baseAvata, 1, 1, 1, 1);
  ctx.drawImage(baseAvata2, 1, 1, 1, 1);
  ctx.drawImage(baseAvata3, 1, 1, 1, 1);
  ctx.font = `700 ${fontsName}px Arial`;
  ctx.fillStyle = `${colorName}`
  ctx.textAlign = "start";
  fontSize = 40;
  ctx.fillText(text, 340, 560);
  ...
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`⊶ عدد الاعضاء: ${threadMem}`, 1245, 448);
  ctx.fillText(`⊶ الادمنية: ${qtv}`, 1245, 505);
  ctx.fillText(`⊶ ذكر: ${nam}`, 1245, 559);
  ctx.fillText(`⊶ انثى: ${nu}`, 1245, 616);
  ctx.fillText(`⊶ عدد رسائل المجموعة: ${sl}`, 1245, 668);
  ctx.font = `${fontsOthers}px Lobster`;
  ctx.fillStyle = "#FF0000";
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`ID BOX: ${id}`, 1245, 723);
  ctx.font = `${fontsOthers}px Lobster`;
  ctx.fillStyle = "#00FF00";
  ctx.textAlign = "start";
  fontSize = 0;
  ctx.fillText(` ${parseInt(threadMem)-3} `, 999999, 453);
  ctx.beginPath();

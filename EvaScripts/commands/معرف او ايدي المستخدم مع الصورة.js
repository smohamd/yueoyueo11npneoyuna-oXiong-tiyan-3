...
const fs = global.nodemodule["fs-extra"];
  ...
  var callback = () =>   api.sendMessage({body:`★★★ 𖣘ايدي المستخدم𖣘 ★★★\n\n━━━━━━━━━━━━━━━━━━\n𖣘★𖣘➜•الاسم• ${name}\n\n𖣘✰𖣘➜•ايدي• ${uid}\n\n𖣘☆𖣘➜ ماسنجر: m.me/${uid}\n\n[✵]➜•رابط•حسابه https://www.facebook.com/profile.php?id=${uid}\n\n━━━━━━━━━━━━━━━━━━\n\n★𓆩ＮＯＮＥ‣᭄𓆪____ ;* 💙💜:)★`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
...
var data = await api.getUserInfoV2(res_ID);
    ...
    if (args.join().indexOf('@') !== -1) 
      ...
      var callback = () => 
api.sendMessage({body:`★★★ 𖣘ايدي المستخدم𖣘 ★★★\n\n━━━━━━━━━━━━━━━━━━\n𖣘★𖣘➜•الاسم• ${name}\n\n𖣘✰𖣘➜•ايدي• ${uid}\n\n𖣘☆𖣘➜ ماسنجر: m.me/${uid}\n\n[✵]➜•رابط•حسابه https://www.facebook.com/profile.php?id=${uid}\n\n━━━━━━━━━━━━━━━━━━\n\n★𓆩ＮＯＮＥ‣᭄𓆪____ ;* 💙💜:)★`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
        () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID); 
    return request(encodeURI(`https://graph.facebook.com/${uid}/picture?height=1500&width=1500&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(fs.createWriteStream(__dirname+'/cache/1.png')).on('close',
        () => callback()); 

...
/*---------------------------------------------*/
  ...
  ctx.fillText(`⊶ الادمنية: ${qtv}`, 439, 243);
  ctx.fillText(`⊶ ذكر: ${nam}`, 439, 287);
  ctx.fillText(`⊶ انثى: ${nu}`, 439, 331);
  ctx.fillText(`⊶ عدد رسائل المجموعة: ${sl}`, 439, 379);
  ...
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`• و ${parseInt(threadMem)-3} عضو...`, 607, 453);
  ctx.beginPath();
